Public Class COUNTERLIST
    ...
    Public Overrides Sub SetFilter(ByVal _criteria As String)
        ...
        Else
            MainView.ActiveFilterString = "DeptCode='" & CURRENT_DEPARTMENT & "'"
        End If
    End Sub
    ...
    Public Overrides Sub RefreshData()
        ...
        Me.MainGrid.DataSource = DB.CreateTable("SELECT * FROM dbo.COUNTERLIST")
    ...
    Public Overrides Function GetID() As String
        If MainView.RowCount > 0 Then
            Return MainView.GetRowCellValue(MainView.FocusedRowHandle, "CounterCode")
        Else
            Return ""
        End If
    End Function
    ...
    Public Overrides Function GetDesc() As String
        If MainView.RowCount > 0 Then
            Return MainView.GetRowCellValue(MainView.FocusedRowHandle, "Counter")
        Else
            Return ""
        End If
    End Function
    ...
    Public Overrides Sub SetSelection(ByVal id As String)
        Try
            ...
            Dim Col As DevExpress.XtraGrid.Columns.GridColumn = MainView.Columns("CounterCode")
