...
Public Class UNITS
    ...
    Private Sub cboLocCode_ProcessNewValue(sender As Object, e As DevExpress.XtraEditors.Controls.ProcessNewValueEventArgs) Handles cboLocCode.ProcessNewValue
        ...
        LastUpdatedBy = clsAudit.AssembleLastUBy(USER_REAL, "", 10, System.Environment.MachineName, e.DisplayValue & "Location", strCaption) 'neil
    ...
    Private Sub DeleteEdit_ButtonClick(sender As Object, e As DevExpress.XtraEditors.Controls.ButtonPressedEventArgs) Handles DeleteEdit.ButtonClick
        ...
        If grid.Name = "MainGrid" Then
            If MsgBox("Are you sure want to delete the " & MainView.GetFocusedRowCellDisplayText("Component") & " Component?", MsgBoxStyle.YesNo) = MsgBoxResult.Yes Then
                lastupdatedby = clsAudit.AssembleLastUBy(USER_REAL, "", 10, System.Environment.MachineName, MainView.GetFocusedRowCellDisplayText("Component") & " Component?", strCaption) 'neil
        ...
        If grid.Name = "MainGrid" Then
            ...
            If frm.bSaved Then
                ...
                If strComponentCode <> "" Then
                    ...
                    End If
                End If
                lastupdatedby = clsAudit.AssembleLastUBy(USER_REAL, "", 10, System.Environment.MachineName, strComponent & " Component", strCaption) 'neil
...
#Region "Tree"
    ...
    Private Sub tlUnits_DragDrop(ByVal sender As Object, ByVal e As DragEventArgs) Handles tlUnits.DragDrop
        ...
        Dim parenttext As String = "", machinename As String = ""
        Dim lastupdatedby As String = GetUserName()
        ...
        Else
            ...
            parenttext = (getallparent(info.Node, "UnitDesc"))
        End If
        ...
        If tbl Is Nothing Then 'Dragged from the Treelist
            ...
            If Not tree Is Nothing Then
                ...
                'LastUpdatedBy = clsAudit.AssembleLastUBy(USER_REAL, "", 10, System.Environment.MachineName, "Machine", strCaption, , , xrow(0)("UnitDesc")) 'neil
                If info.Node Is Nothing Then
                    machinename = xrow(0)("UnitDesc")
                Else
                    machinename = info.Node.RootNode.GetValue("UnitDesc")
                End If
                LastUpdatedBy = clsAudit.AssembleLastUBy(USER_REAL, "", 10, System.Environment.MachineName,
                                         parenttext & " : " & xrow(0)("UnitDesc") & " Component",
                                         strCaption, , , machinename) 'neil
        ...
        Else 'Dragged from the Data Grid
            ...
            For Each row In tbl.Rows
                ...
                'LastUpdatedBy = clsAudit.AssembleLastUBy(USER_REAL, "", 10, System.Environment.MachineName, "Machine", strCaption, , , rowNew("UnitDesc")) 'neil
                If info.Node Is Nothing Then
                    machinename = rowNew("UnitDesc")
                Else
                    machinename = info.Node.RootNode.GetValue("UnitDesc")
                End If
                LastUpdatedBy = clsAudit.AssembleLastUBy(USER_REAL, "", 10, System.Environment.MachineName,
                                         parenttext & " : " & rowNew("UnitDesc") & " Component",
                                         strCaption, , , machinename) 'neil
    ...
    Function getallparent(ByRef nodemo As DevExpress.XtraTreeList.Nodes.TreeListNode, columnname As String) As String
        Dim ret As String = ""

        If Not nodemo.ParentNode Is Nothing Then
            ret = ret & getallparent(nodemo.ParentNode, columnname) & " : " & nodemo.GetValue(columnname)
        Else
            ret = ret & nodemo.GetValue(columnname)
        End If
...
#Region "Other Functions"
    ...
    Public Overrides Sub DeleteData()
        ...
        Else
            If MsgBox("Are you sure want to delete the " & xNode.GetValue("UnitDesc") & " Component?", MsgBoxStyle.YesNo) = MsgBoxResult.Yes Then
                ...
                LastUpdatedBy = clsAudit.AssembleLastUBy(USER_REAL, "", 10, System.Environment.MachineName,
                                               getallparent(xNode, "UnitDesc") & " Component",
                                               strCaption, , , xNode.RootNode.GetValue("UnitDesc")) 'neil
    ...
    Public Overrides Sub SaveData()
        If ValidateFields(New DevExpress.XtraEditors.BaseEdit() {txtUnitDesc}) Then
            ...
            'lastupdatedby = clsAudit.AssembleLastUBy(USER_REAL, "", 10, System.Environment.MachineName,
            '                                     Replace(strDesc, "->", " - ") & " : " & mView.GetRowCellDisplayText(i, "WorkCode"),
            '                                     strCaption, , , strDesc.Split(New String() {" ->"}, 0)(0), ,
            '                                       IIf(chkCritical.Checked, 1, 2)) 'neil
            ...
            For i = 0 To mView.RowCount - 1
                If mView.GetRowCellValue(i, "mEdited") Then
                    ...
                    'lastupdatedby = clsAudit.AssembleLastUBy(USER_REAL, "", 10, System.Environment.MachineName,
                    '                             Replace(strDesc, "->", " - ") & " : " & mView.GetRowCellDisplayText(i, "WorkCode") & " maintenance",
                    '                             strCaption, , , strDesc.Split(New String() {" ->"}, 0)(0), IIf(IfNull(mView.GetRowCellValue(mView.FocusedRowHandle, "IntCode"), "") = "", 2, 1),
                    '                             chkCritical.Tag, mView.GetRowCellDisplayText(i, "WorkCode")) 'neil
                    lastupdatedby = clsAudit.AssembleLastUBy(USER_REAL, "", 10, System.Environment.MachineName,
                                               Replace(strDesc, "->", " - ") & " : " & mView.GetRowCellDisplayText(i, "WorkCode") & " maintenance",
                                               strCaption, , , strDesc.Split(New String() {" ->"}, 0)(0)) 'neil
                    ...
                    If mView.GetRowCellValue(i, "MaintenanceCode") Is System.DBNull.Value Then
                        sqls.Add("INSERT INTO [dbo].[tblAdmMaintenance]([MaintenanceCode],[WorkCode],[UnitCode],[RankCode],[Number],[IntCode],[InsCrossRef],[InsEditor],[InsDocument],[InsDateIssue],[InsDesc],[LastUpdatedBy],[HasImage]) " & _
                                 "Values(dbo.MAINTENANCEID(),'" & mView.GetRowCellValue(i, "WorkCode") & "', '" & strID & "', '" & mView.GetRowCellValue(i, "RankCode") & "', " & IfNull(mView.GetRowCellValue(i, "Number"), "NULL") & ", '" & mView.GetRowCellValue(i, "IntCode") & "', '" & mView.GetRowCellValue(i, "InsCrossRef").ToString.Replace("'", "''") & "', '" & mView.GetRowCellValue(i, "InsEditor").ToString.Replace("'", "''") & "', '" & mView.GetRowCellValue(i, "InsDocument").ToString.Replace("'", "''") & "', " & strDateIssue & ", '" & mView.GetRowCellValue(i, "InsDesc").ToString.Replace("'", "''") & "','" & LastUpdatedBy & "'," & IIf(mView.GetRowCellValue(i, "HasImage"), 1, 0) & ")")
                    Else
                        sqls.Add("Update dbo.tblAdmMaintenance set WorkCode='" & mView.GetRowCellValue(i, "WorkCode") & "',RankCode='" & mView.GetRowCellValue(i, "RankCode") & "',Number=" & IfNull(mView.GetRowCellValue(i, "Number"), "NULL") & ",IntCode='" & mView.GetRowCellValue(i, "IntCode") & "',InsCrossRef='" & mView.GetRowCellValue(i, "InsCrossRef").ToString.Replace("'", "''") & "',InsEditor='" & mView.GetRowCellValue(i, "InsEditor").ToString.Replace("'", "''") & "',InsDocument='" & mView.GetRowCellValue(i, "InsDocument").ToString.Replace("'", "''") & "',InsDateIssue=" & strDateIssue & ",InsDesc='" & mView.GetRowCellValue(i, "InsDesc").ToString.Replace("'", "''") & "', LastUpdatedBy='" & LastUpdatedBy & "', DateUpdated=GETDATE(), HasImage=" & IIf(mView.GetRowCellValue(i, "HasImage"), 1, 0) & " Where MaintenanceCode='" & mView.GetRowCellValue(i, "MaintenanceCode") & "'")
                    End If
                    ...
                    If IfNull(mView.GetRowCellValue(i, "DeletedImages"), "") <> "" Then
                        ...
                        LastUpdatedBy = clsAudit.AssembleLastUBy(USER_REAL, "", 10, System.Environment.MachineName, "Documents", strCaption, , , txtUnitDesc.EditValue) 'neil
            ...
            LastUpdatedBy = clsAudit.AssembleLastUBy(USER_REAL, "", 10, System.Environment.MachineName, "Parts", strCaption, , , txtUnitDesc.EditValue) 'neil
                ...
                If pView.GetRowCellValue(i, "pEdited") Then
                    If pView.GetRowCellValue(i, "PartCode") Is System.DBNull.Value Then
                        ...
                        sqls.Add("INSERT INTO [dbo].[tblAdmPart]([PartCode],[Name],[PartNumber],[LastUpdatedBy]) " & _
                                 "Values('" & strPartID & "', '" & pView.GetRowCellValue(i, "Part") & "','" & pView.GetRowCellValue(i, "PartNumber").ToString & "','" & LastUpdatedBy & "')")
                        pView.SetRowCellValue(i, "PartCode", strPartID)
                    Else
                        sqls.Add("Update dbo.tblAdmPart set [Name]='" & pView.GetRowCellValue(i, "Part") & "',[PartNumber]='" & pView.GetRowCellValue(i, "PartNumber") & "', LastUpdatedBy='" & LastUpdatedBy & "' Where PartCode='" & pView.GetRowCellValue(i, "PartCode") & "'")
                    End If
            ...
            LastUpdatedBy = clsAudit.AssembleLastUBy(USER_REAL, "", 10, System.Environment.MachineName, "Counter", strCaption, , , txtUnitDesc.EditValue) 'neil

            For i = 0 To cView.RowCount - 1
                If cView.GetRowCellValue(i, "cEdited") Then
                    strCounterCode = GenerateID(DB, "CounterCode", "tblAdmCounter")
                    sqls.Add("Insert Into dbo.tblAdmCounter([CounterCode],[Name],[UnitCode],[LastUpdatedBy],[SortCode]) Values('" & strCounterCode & "','" & cView.GetRowCellValue(i, "Counter").ToString.Replace("'", "''") & "','" & strID & "','" & LastUpdatedBy & "',100)")
                End If
            Next
    ...
    Sub UpdateCriticalParent(pNode As TreeListNode)
        ...
        lastupdatedby = clsAudit.AssembleLastUBy(USER_REAL, "", 10, System.Environment.MachineName, "", strCaption, , 0, strDesc.Split(New String() {" ->"}, 0)(0), , IIf(chkCritical.Checked, 1, 2)) 'neil
    ...
    Sub UpdateActiveParent(pNode As TreeListNode)
        ...
        lastupdatedby = clsAudit.AssembleLastUBy(USER_REAL, "", 10, System.Environment.MachineName, "Macine", strCaption, , 0, strDesc.Split(New String() {" ->"}, 0)(0)) 'neil
    ...
    Sub UpdateActiveChild(pNode As TreeListNode, bActive As Boolean)
        If pNode.HasChildren Then
            ...
            Dim lastupdatedby As String = GetUserName()
            lastupdatedby = clsAudit.AssembleLastUBy(USER_REAL, "", 10, System.Environment.MachineName, "Unit", strCaption, , 0, txtUnitDesc.EditValue) 'neil

            While en.MoveNext
                nNode = CType(en.Current, TreeListNode)
                nNode.SetValue("Active", bActive)
                nNode.SetValue("HasInactive", Not bActive)
                sqls.Add("UPDATE dbo.tblAdmUnit SET HasInactive=" & IIf(bActive, 0, 1) & ", Active=" & IIf(bActive, 1, 0) & ",LastUpdatedBy='" & LastUpdatedBy & "' WHERE UnitCode='" & nNode.GetValue("UnitCode") & "'")
    ...
    Sub CreateDeleteSQLs(xrow() As DataRow)
        ...
        For i = 0 To xrow.Length - 1
            ...
            lastupdatedby = clsAudit.AssembleLastUBy(USER_REAL, "", 10, System.Environment.MachineName, "Unit", strCaption, , , xrow(i)("UnitDesc"), , IIf(chkCritical.Checked, 1, 2)) 'neil
            clsAudit.saveAuditPreDelDetails("tblAdmUnit", xrow(i)("UnitCode"), LastUpdatedBy)
...
#End Region
    ...
    Private Sub cboCatCode_ProcessNewValue(sender As Object, e As DevExpress.XtraEditors.Controls.ProcessNewValueEventArgs) Handles cboCatCode.ProcessNewValue
        ...
        Dim lastupdatedby As String = GetUserName()
        lastupdatedby = clsAudit.AssembleLastUBy(USER_REAL, "", 10, System.Environment.MachineName, e.DisplayValue & " Category", strCaption) 'neil
    ...
    Private Sub cboVendorCode_ProcessNewValue(sender As Object, e As DevExpress.XtraEditors.Controls.ProcessNewValueEventArgs) Handles cboVendorCode.ProcessNewValue
        ...
        Dim lastupdatedby As String = GetUserName()
        LastUpdatedBy = clsAudit.AssembleLastUBy(USER_REAL, "", 10, System.Environment.MachineName, e.DisplayValue & " Vendor", strCaption) 'neil
        ...
        ElseIf strCurrView = "Maintenance" Then
            ...
            If Not nRow Is Nothing Then
                ...
                For Each crow In nRow
                    ...
                    LastUpdatedBy = clsAudit.AssembleLastUBy(USER_REAL, "", 10, System.Environment.MachineName, "Maintenance", strCaption) 'neil

                    sqls.Add("INSERT INTO dbo.tblAdmMaintenance(MaintenanceCode, WorkCode, UnitCode, LastUpdatedBy) VALUES(dbo.MAINTENANCEID(),'" & strCode & "', '" & strID & "', '" & LastUpdatedBy & "')")
                    'If Not bExist Then
                    '    MainView.AddNewRow()
