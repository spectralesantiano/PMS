Public Class DEPARTMENTLIST
    ...
    Public Overrides Sub RefreshData()
        ...
        Me.MainGrid.DataSource = DB.CreateTable("SELECT * FROM dbo.DEPARTMENTLIST")
    ...
    Public Overrides Function GetID() As String
        If MainView.RowCount > 0 Then
            Return MainView.GetRowCellValue(MainView.FocusedRowHandle, "DeptCode")
        Else
            Return ""
        End If
    End Function
    ...
    Public Overrides Function GetDesc() As String
        If MainView.RowCount > 0 Then
            Return MainView.GetRowCellValue(MainView.FocusedRowHandle, "Department")
        Else
            Return ""
        End If
    End Function
    ...
    Public Overrides Sub SetSelection(ByVal id As String)
        Try
            ...
            Dim Col As DevExpress.XtraGrid.Columns.GridColumn = MainView.Columns("DeptCode")
