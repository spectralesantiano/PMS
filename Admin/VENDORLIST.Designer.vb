...
Partial Class VENDORLIST
    ...
    Private Sub InitializeComponent()
        ...
        Me.Vendor = New DevExpress.XtraGrid.Views.BandedGrid.BandedGridColumn()
        Me.VendorCode = New DevExpress.XtraGrid.Views.BandedGrid.BandedGridColumn()
        Me.CntryCode = New DevExpress.XtraGrid.Views.BandedGrid.BandedGridColumn()
        Me.Address = New DevExpress.XtraGrid.Views.BandedGrid.BandedGridColumn()
        Me.ContactPerson = New DevExpress.XtraGrid.Views.BandedGrid.BandedGridColumn()
        Me.Email = New DevExpress.XtraGrid.Views.BandedGrid.BandedGridColumn()
        ...
        Me.MainView.Columns.AddRange(New DevExpress.XtraGrid.Views.BandedGrid.BandedGridColumn() {Me.VendorCode, Me.Vendor, Me.CntryCode, Me.Address, Me.ContactPerson, Me.Email})
        ...
        Me.MainView.SortInfo.AddRange(New DevExpress.XtraGrid.Columns.GridColumnSortInfo() {New DevExpress.XtraGrid.Columns.GridColumnSortInfo(Me.Vendor, DevExpress.Data.ColumnSortOrder.Ascending)})
        '
        'gridBand4
        '
        Me.gridBand4.Caption = "gridBand4"
        Me.gridBand4.Columns.Add(Me.Vendor)
        ...
        'CntryCode
        '
        Me.CntryCode.Caption = "CntryCode"
        Me.CntryCode.FieldName = "CntryCode"
        Me.CntryCode.Name = "CntryCode"
        '
        'Address
        '
        ...
        'ContactPerson
        '
        Me.ContactPerson.Caption = "ContactPerson"
        Me.ContactPerson.FieldName = "ContactPerson"
    ...
    Friend WithEvents Vendor As DevExpress.XtraGrid.Views.BandedGrid.BandedGridColumn
    Friend WithEvents VendorCode As DevExpress.XtraGrid.Views.BandedGrid.BandedGridColumn
    Friend WithEvents gridBand4 As DevExpress.XtraGrid.Views.BandedGrid.GridBand
    Friend WithEvents CntryCode As DevExpress.XtraGrid.Views.BandedGrid.BandedGridColumn
    Friend WithEvents Address As DevExpress.XtraGrid.Views.BandedGrid.BandedGridColumn
    Friend WithEvents ContactPerson As DevExpress.XtraGrid.Views.BandedGrid.BandedGridColumn
    Friend WithEvents Email As DevExpress.XtraGrid.Views.BandedGrid.BandedGridColumn
