Public Class VLOCATIONLIST
    ...
    Public Overrides Sub RefreshData()
        ...
        Me.MainGrid.DataSource = DB.CreateTable("SELECT * FROM dbo.LOCATIONLIST")
    ...
    Public Overrides Function GetID() As String
        If MainView.RowCount > 0 Then
            Return MainView.GetRowCellValue(MainView.FocusedRowHandle, "LocCode")
        Else
            Return ""
        End If
    End Function
    ...
    Public Overrides Function GetDesc() As String
        If MainView.RowCount > 0 Then
            Return MainView.GetRowCellValue(MainView.FocusedRowHandle, "LocName")
        Else
            Return ""
        End If
    End Function
    ...
    Public Overrides Sub SetSelection(ByVal id As String)
        Try
            ...
            Dim Col As DevExpress.XtraGrid.Columns.GridColumn = MainView.Columns("LocCode")
    ...
    Sub PasteData(strMode As String)
        ...
        If strMode = "Paste" Then
            nRow = ImportFromClipboard("Location", "")
        Else
            nRow = ImportFromFile("Location", "")
        End If
        If Not nRow Is Nothing Then
            For Each crow In nRow
                Dim bExist As Boolean = True, strValue As String = crow("Location")
                Dim strCode As String = PasteAdminData(DB, "LocCode", "tblAdmLocation", strValue, bExist)
                If Not bExist Then
                    MainView.AddNewRow()
                    MainView.SetRowCellValue(MainView.FocusedRowHandle, "LocCode", strCode)
                    MainView.SetRowCellValue(MainView.FocusedRowHandle, "LocName", strValue)
