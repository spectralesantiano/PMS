Public Class STORAGELIST
    ...
    Public Overrides Sub RefreshData()
        ...
        Me.MainGrid.DataSource = DB.CreateTable("SELECT * FROM dbo.STORAGELIST")
    ...
    Public Overrides Function GetID() As String
        If MainView.RowCount > 0 Then
            Return MainView.GetRowCellValue(MainView.FocusedRowHandle, "StorageCode")
        Else
            Return ""
        End If
    End Function
    ...
    Public Overrides Function GetDesc() As String
        If MainView.RowCount > 0 Then
            Return MainView.GetRowCellValue(MainView.FocusedRowHandle, "Storage")
        Else
            Return ""
        End If
    End Function
    ...
    Public Overrides Sub SetSelection(ByVal id As String)
        Try
            ...
            Dim Col As DevExpress.XtraGrid.Columns.GridColumn = MainView.Columns("StorageCode")
    ...
    Sub PasteData(strMode As String)
        ...
        If strMode = "Paste" Then
            nRow = ImportFromClipboard("Storage", "")
        Else
            nRow = ImportFromFile("Storage", "")
        End If
        If Not nRow Is Nothing Then
            For Each crow In nRow
                Dim bExist As Boolean = True, strValue As String = crow("Storage")
                Dim strCode As String = PasteAdminData(DB, "StorageCode", "tblAdmStorage", strValue, bExist)
                If Not bExist Then
                    MainView.AddNewRow()
                    MainView.SetRowCellValue(MainView.FocusedRowHandle, "StorageCode", strCode)
                    MainView.SetRowCellValue(MainView.FocusedRowHandle, "Storage", strValue)
