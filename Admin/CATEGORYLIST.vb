Public Class CATEGORYLIST
    ...
    Public Overrides Sub RefreshData()
        ...
        Me.MainGrid.DataSource = DB.CreateTable("SELECT * FROM dbo.CATEGORYLIST ORDER BY Category")
    ...
    Public Overrides Function GetID() As String
        If MainView.RowCount > 0 Then
            Return MainView.GetRowCellValue(MainView.FocusedRowHandle, "CatCode")
        Else
            Return ""
        End If
    End Function
    ...
    Public Overrides Function GetDesc() As String
        If MainView.RowCount > 0 Then
            Return MainView.GetRowCellValue(MainView.FocusedRowHandle, "Category")
        Else
            Return ""
        End If
    End Function
    ...
    Public Overrides Sub SetSelection(ByVal id As String)
        Try
            ...
            Dim Col As DevExpress.XtraGrid.Columns.GridColumn = MainView.Columns("CatCode")
    ...
    Sub PasteData(strMode As String)
        ...
        If strMode = "Paste" Then
            nRow = ImportFromClipboard("Category", "")
        Else
            nRow = ImportFromFile("Category", "")
        End If
        If Not nRow Is Nothing Then
            For Each crow In nRow
                Dim bExist As Boolean = True, strValue As String = crow("Category")
                Dim strCode As String = PasteAdminData(DB, "CatCode", "tblAdmCategory", strValue, bExist)
                If Not bExist Then
                    MainView.AddNewRow()
                    MainView.SetRowCellValue(MainView.FocusedRowHandle, "CatCode", strCode)
                    MainView.SetRowCellValue(MainView.FocusedRowHandle, "Category", strValue)
