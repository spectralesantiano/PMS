...
Partial Class CATEGORYLIST
    ...
    Private Sub InitializeComponent()
        ...
        Me.Category = New DevExpress.XtraGrid.Views.BandedGrid.BandedGridColumn()
        ...
        Me.MainView.Columns.AddRange(New DevExpress.XtraGrid.Views.BandedGrid.BandedGridColumn() {Me.CatCode, Me.Category})
        ...
        Me.MainView.SortInfo.AddRange(New DevExpress.XtraGrid.Columns.GridColumnSortInfo() {New DevExpress.XtraGrid.Columns.GridColumnSortInfo(Me.Category, DevExpress.Data.ColumnSortOrder.Ascending)})
        '
        'gridBand4
        '
        Me.gridBand4.Caption = "gridBand4"
        Me.gridBand4.Columns.Add(Me.Category)
    ...
    Friend WithEvents Category As DevExpress.XtraGrid.Views.BandedGrid.BandedGridColumn
