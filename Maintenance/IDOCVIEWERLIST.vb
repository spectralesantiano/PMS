Public Class IDOCVIEWERLIST
    ...
    Public Overrides Sub RefreshData()
        ...
        Me.MainGrid.DataSource = DB.CreateTable("SELECT * FROM dbo.IDOCVIEWERLIST")
    ...
    Public Overrides Sub SetSelection(ByVal id As String)
        Try
            ...
            Dim Col As DevExpress.XtraGrid.Columns.GridColumn = MainView.Columns("Part_MissingID")
