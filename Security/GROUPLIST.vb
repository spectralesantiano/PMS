Public Class GROUPLIST
    ...
    Public Overrides Sub RefreshData()
        ...
        Me.MainGrid.DataSource = DB.CreateTable("SELECT * FROM dbo.GROUPLIST")
    ...
    Public Overrides Function GetID() As String
        If MainView.RowCount > 0 Then
            Return MainView.GetRowCellValue(MainView.FocusedRowHandle, "GroupID").ToString
        Else
            Return ""
        End If
    End Function
    ...
    Public Overrides Function GetDesc() As String
        If MainView.RowCount > 0 Then
            Return MainView.GetRowCellValue(MainView.FocusedRowHandle, "GroupName")
        Else
            Return ""
        End If
    End Function
